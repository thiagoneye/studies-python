...
from a file named evaluate.py from the level where the classes are imported.

Therefore, instead of the name of the module __main__, the response will be
the name of the module in which this class is implemented, in this case exercise.
"""
