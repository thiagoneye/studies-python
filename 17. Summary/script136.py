"""
The Note class (representation of a note) is given.

Implement the Notebook class (representation of a notebook with notes) with two methods:
- __init__() for creating an instance attribute of the Notebook class named notes (an empty list where the notes will be stored).
