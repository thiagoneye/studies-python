"""
A class called Pet is implemented that has two properties: name and age (see below).

Add validation to the age property at the stage of object creation and attribute modification:
    - the value of the age attribute must be an int type,
    otherwise raise a TypeError with the following message:

        'The value of age must be of type int.'

    - the value of the age attribute must be positive, otherwise raise ValueError with the
    following message:
