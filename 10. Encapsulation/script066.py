...
Next implement the methods: name() and age(), which reads the value of the protected attributes: name and age.
Using the @property decorator, create properties: name and age, respectively (read-only properties).

Create an instance of the Pet class named pet and set the name attribute to 'Max' and age to 5.
