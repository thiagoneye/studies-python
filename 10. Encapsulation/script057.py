"""
A class called Laptop was implemented. Implement a method named set_price() to modify price attribute that validates the value. Validation checks:
...
Then create an instance of the Laptop class with a price of 3499 and try to set '-3000' to the price using set_price() method.
